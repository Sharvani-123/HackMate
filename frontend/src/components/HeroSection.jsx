...
import connectedWorldIllustration from '../assets/Connected world-cuate.svg';

const HeroSection = () => {
  return (
   <section  className='px-4 pb-4 bg-gradient-to-bl from-gray-200 via-white to-gray-250 py-16'>
    {/* Hero Content with Illustration */}
    <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-12">
      ...
      <div className="text-center lg:text-left">
        ...
        {/* Buttons - moved here for better layout */}
      ...
      <div className="flex justify-center lg:justify-end">
        <img 
          src={connectedWorldIllustration} 
    ...
    {/*Feature Cards*/}
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-8 text-center">
        {/* Card 1 */}
